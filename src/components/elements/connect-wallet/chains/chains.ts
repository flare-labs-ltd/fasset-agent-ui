 ...
 *  This section was autogenerated by src/scripts/supported-chains.ts
 *  script based on .env file.
 *  For more intormation read developer docs.
 *  @see /docs/devDocs/README.md
 *  Do not remove commented lines above and bellow this section!
 */
